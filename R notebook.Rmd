...
our goal is to Identify whether the chances of of a heart attack occurrence is high low for the patient
...
Class label:
-target to Heart Attack accurrance
-not target to Heart Attackn accurrance
